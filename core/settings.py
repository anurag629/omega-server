...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'omega_db'),
        'USER': os.getenv('DB_USER', 'omega_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'omega_password'),
...
# Custom User Model
AUTH_USER_MODEL = 'omega_auth.CustomUser'
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'codercops@codercops.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'codercops@codercops.com')
